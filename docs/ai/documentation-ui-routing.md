...
| DossierSanitaire | `screens/Health/DossierSanitaire` | Dossiers sanitaires | **`ListeEcranLayout`** ; MultiSelect groupes + Dropdown filtre contenu ; cartes pressables → **`DossierEnfantModal`** (consultation + édition par section) |
