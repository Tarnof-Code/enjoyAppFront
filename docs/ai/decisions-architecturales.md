...
- **`BoutonModePaysageGrille`** + **`ConteneurGrillePaysage`** : bascule paysage **visuelle** (rotation 90° du scroll grille) sur **`Menus`** et **`GrilleDetail`** ; hook **`useModePaysageGrille`** ; l'appareil reste en portrait (`app.json`).
