...
- [x] Plannings organisation : liste tri alpha + recherche ; détail matrice multi-jours (1/3/5) ; édition cellules (`PlanningCelluleModal`, `planningGrilleUtils`, PUT/PATCH API) ; droits directeur/adjoint vs animateur.
