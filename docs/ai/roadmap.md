...
- [x] **Phase B** — Listes (Équipe, Enfants, Groupes, Chambres), Menus, Organisation (+ détail grille), Activités/Sorties, Sanitaire (top-tabs Dossier sanitaire + Cahier d'infirmerie CRUD).
