...
- [x] **Sanitaire — dossier enfant modale** : tap carte **`DossierSanitaire`** → **`DossierEnfantModal`** ; édition par section (directeur/adjoint/AS) ; `GET/PUT …/dossier` ; réf. alimentaires.
