...
const data = [
  ...
  { label: 'Direction 1', value: 'Direction 1' },
  { label: 'Direction 2', value: 'Direction 2' },
];

interface DropdownAnimDirectionProps {
  animSelectedParent: (value: string) => void;
}

const DropdownAnimDirection = ({ animSelectedParent }: DropdownAnimDirectionProps) => {
...
export default DropdownAnimDirection;
