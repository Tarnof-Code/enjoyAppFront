...
interface DropdownDatesProps {
  dateSelectedParent: (value: string) => void;
}

const DropdownDates = ({ dateSelectedParent }: DropdownDatesProps) => {
